...
g++ -c -O3 -std=gnu++14 -o finalSrc/mainTestWritheScatter.o finalSrc/mainTestWritheScatter.cpp -fopenmp
g++ -O3-std=gnu++14 -o writheScatterTest finalSrc/point.o finalSrc/optimizationPoint.o finalSrc/polyHelix.o finalSrc/randomMolGen.o finalSrc/ktlMoleculeRandom.o finalSrc/experimentalData.o finalSrc/hydrationShellRandom.o finalSrc/binayFind.o finalSrc/mutualWind2.o finalSrc/localWrithe.o finalSrc/mainTestWritheScatter.o -fopenmp
